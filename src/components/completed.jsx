...
import Img from "./images/icons/mainRed/check-mark.png"; // Import the inbox icon image
...
function Completed() {
  ...
  useEffect(() => {
    document.title = " maham - Completed"; // Set the document title
  }, []);
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <div className="overflow-scroll h-[670px]">
        <InboxCard showTodayText={true} type={"completed"} />{" "}

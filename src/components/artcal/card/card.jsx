...
function Card({ task, showTodayText, type }) {
  // State variables
  ...
  return (
    <div
      ...
      className="task flex relative h-16 px-6 py-4 shadow-sm rounded-md bg-white  dark:bg-secondDark dark:border dark:border-lightBlue justify-between items-center cursor-pointer  dark:hover:bg-LightDark duration-300"
    >
      <div className="flex items-center gap-2">
        {type === "completed" ? (
          <div
            ...
            className={` ${
              type === "completed" ? "Comcheckbox" : "checkbox"
            }  w-5 h-5 relative rounded-full border-2 border-mainRed bg-mainRed  dark:opacity-100 cursor-pointer`}
          ></div>
        ) : (
          <div
            onClick={handleCheck} // Handle checkbox click
        ...
        <Text task={task} showTodayText={showTodayText} />{" "}
